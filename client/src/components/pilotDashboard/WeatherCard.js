...
const ErrorDisplay = () => (
    <div className="w-full mx-auto p-6 pt-4 h-60 text-center bg-white hover:bg-gray-200/10 transition-all 
...
const WeatherCard = () => {
    ...
    return (
        <div className=" overflow-auto p-6 pt-4 bg-white  transition-all 
